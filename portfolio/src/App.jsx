  ...
  return (
    <div className="App">
      ...
      <div className="profile-pic-container">
        <img src={profilePic} alt="Conrad Bugingo" className="profile-pic" />
      </div>
          ...
          <Box className="fade-in">
            ...
            <div className="projects-grid">
              <div className="project-tile">
                <img src={microloanTracker} alt="Microloan Tracker" className="project-img" />
              ...
              <div className="project-tile">
                <img src={cryptoTrends} alt="Crypto Trends" className="project-img" />
                <h3>Crypto Trends</h3>
                <Typography variant="body2">
            ...
            {showMore && (
              <div className="projects-grid">
                ...
                <div className="project-tile">
                  <img src={distanceCalculator} alt="Distance Calculator" className="project-img" />
                ...
                <div className="project-tile">
                  <img src={placeholder} alt="Coming Soon" className="project-img" />
                  <h3>Coming Soon</h3>
                  <Typography variant="body2">
