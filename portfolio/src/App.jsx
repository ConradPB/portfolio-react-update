  ...
  return (
    <div className="App">
      ...
      <div className="profile-pic-container">
        <img src="/public/assets/snapshots/profile.jpg" alt="Conrad Bugingo" className="profile-pic" />
      </div>
        ...
        <Container>
          <Box className="fade-in">
            ...
            <div className="projects-grid">
              ...
              <div className="project-tile">
                <img src="/public/assets/screenshots/crypto-trends.png" alt="Crypto Trends" className="project-img" />
                <h3>Crypto Trends</h3>
                <Typography variant="body2">
            ...
            {showMore && (
              <div className="projects-grid">
                <div className="project-tile">
                  <img src="/public/assets/screenshots/eesclug.png" alt="EESCL Uganda" className="project-img" />
                  <h3>EESCL Uganda</h3>
                  <Typography variant="body2">
                ...
                <div className="project-tile">
                  <img src="/public/assets/screenshots/calc.png" alt="Distance Calculator" className="project-img" />
